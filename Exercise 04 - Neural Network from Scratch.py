...
class TestFeedForwardNeuralNetwork(unittest.TestCase):
    ...
    def test_setters_getters(self):
        ...
        self.assertEqual(len(m1.theta_), 9+4, "Wrong number of parameters for the model")
        self.assertEqual(len(m2.theta_), 12+5, "Wrong number of parameters for the model")
    ...
    def test_sigmoid(self):
        self.assertAlmostEqual(self.model._sigmoid(0), .5, places=3, 
                               msg='Sigmoid function seems off')
        self.assertAlmostEqual(self.model._sigmoid(-1e2), 0, places=3, 
                               msg='Sigmoid function seems off')
        self.assertAlmostEqual(self.model._sigmoid(1e2), 1, places=3, 
                               msg='Sigmoid function seems off')
    ...
    def test_predict(self):
        ...
        self.assertIsInstance(pred, np.ndarray, 
                              msg="The predict() output should be a numpy ndarray")
        self.assertEqual(pred.ndim, 1, 
                         msg="Prediction output should be a flat vector")
    #     # Specifics
    ...
    def test_score(self):
        ...
        self.assertIsInstance(score, float, 
                              msg="The score should be a single value")
        # Specifics
        self.assertTrue(score>=0, 
                        msg="Accuracy should be a value between 0 and 1")
